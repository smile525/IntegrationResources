 ...
 * invoking application after initial validation of parameters and state. The main_menu processing is
 ...
 * to complete on the the main_menu or GUI thread can cause problems. The non-blocking interface
