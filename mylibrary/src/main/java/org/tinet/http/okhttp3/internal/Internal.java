...
/**
 * Escalate internal APIs in {@code org.tinet.http.okhttp3} so they can be used from OkHttp's implementation
...
public abstract class Internal {
  ...
  // TODO delete the following when web sockets move into the main_menu package.
